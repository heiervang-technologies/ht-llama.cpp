 ...
 * - Integrates with DialogChatAttachmentsPreview for full-size viewing
 ...
 * - Integrates with ModelsSelectorList for model selection in router mode
 ...
 * - **MCP**: MCP server management (opens ChatSettings with MCP tab)
...
/* HT integration shims for upstream's Spring Cleaning structure */
