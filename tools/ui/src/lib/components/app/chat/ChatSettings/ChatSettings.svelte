<script lang="ts">
	...
	import ThemeHuePicker from '$lib/components/app/settings/SettingsChat/ThemeHuePicker.svelte';
	import TtsRefAudioPicker from '$lib/components/app/settings/SettingsChat/TtsRefAudioPicker.svelte';
	import AiCommandsEditor from '$lib/components/app/settings/SettingsChat/AiCommandsEditor.svelte';
	import NextcloudConnectionPanel from '$lib/components/app/settings/SettingsChat/NextcloudConnectionPanel.svelte';
			...
			<div class="grid">
				...
				{:else if currentSection.title === SETTINGS_SECTION_TITLES.AI_COMMANDS}
					<AiCommandsEditor
						...
						onChange={(next: string) => handleConfigChange(SETTINGS_KEYS.AI_COMMANDS, next)}
					/>
					...
					<div class="space-y-6">
						...
						{#if currentSection.title === SETTINGS_SECTION_TITLES.TTS}
							<TtsRefAudioPicker
								...
								onChange={({ dataUri, fileName }: { dataUri: string; fileName: string }) => {
