<script lang="ts">
	...
	let editedContent: string = $derived(message.content as string);
	...
	setMessageEditContext({
		...
		get originalExtras(): DatabaseMessageExtra[] {
			return (message.extra as DatabaseMessageExtra[]) || [];
		},
