...
SOURCE_FATTN_VEC_512 = """DECL_FATTN_VEC_CASE(512, {type_k}, {type_v});
"""
TYPES_KV_512 = ["GGML_TYPE_Q4_0", "GGML_TYPE_Q8_0"]
...
for type_k in TYPES_KV:
    for type_v in TYPES_KV:
        with open(f"fattn-vec-instance-{get_short_name(type_k)}-{get_short_name(type_v)}.cu", "w") as f:
            ...
            if type_k == type_v and type_k in TYPES_KV_512:
                f.write(SOURCE_FATTN_VEC_512.format(type_k=type_k, type_v=type_v))
