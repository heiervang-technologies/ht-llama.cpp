...
const char * llama_ftype_name(llama_ftype ftype) {
    ...
    switch ((enum llama_ftype) (ftype & ~LLAMA_FTYPE_GUESSED)) {
        ...
        case LLAMA_FTYPE_MOSTLY_TBQ3_0:    name = LLAMA_FTYPE_PREFIX "TBQ3_0"; break;
        case LLAMA_FTYPE_MOSTLY_TBQ4_0:    name = LLAMA_FTYPE_PREFIX "TBQ4_0"; break;
...
llama_model_loader::llama_model_loader(
    ...
    // TODO: make optional
    {
        ...
        switch (type_max) {
            ...
            case GGML_TYPE_TBQ3_0:  ftype = LLAMA_FTYPE_MOSTLY_TBQ3_0;  break;
            case GGML_TYPE_TBQ4_0:  ftype = LLAMA_FTYPE_MOSTLY_TBQ4_0;  break;
            default:
                {
